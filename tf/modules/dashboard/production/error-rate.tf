resource "google_monitoring_dashboard" "error-rate-prod" {
  dashboard_json = <<EOF
{
  "category": "CUSTOM",
  ...
  "mosaicLayout": {
    ...
    "tiles": [
            ...
            "dataSets": [
              {
                ...
                "timeSeriesQuery": {
                  ...
                  "timeSeriesFilter": {
                    ...
                    "filter": "metric.type=\"logging.googleapis.com/log_entry_count\" resource.type=\"k8s_container\" metric.label.\"severity\"=\"ERROR\" resource.label.\"pod_name\"=monitoring.regex.full_match(\"nginx-ingress-controller-.+\") resource.label.\"cluster_name\"=\"wbaas-3\""
                  }
                }
              }
            ],
      ...
      },
      {
        ...
        "widget": {
          "logsPanel": {
            "filter": "resource.labels.cluster_name=\"wbaas-3\"\nseverity=ERROR\n-\"cert-manager\"",
            "resourceNames": [
