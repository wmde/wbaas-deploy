  ...
  upgrade_settings {
    ...
    blue_green_settings {
      standard_rollout_policy {
        batch_node_count    = 1
        batch_soak_duration = "16200s" # 30mins longer than https://github.com/wmde/wbaas-deploy/blob/db105181696f9dc17060bab618b69d3097688140/k8s/helmfile/env/production/elasticsearch-1.values.yaml.gotmpl#L31
      }
    }
  }
}
