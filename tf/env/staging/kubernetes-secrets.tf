module "wbaas2-k8s-secrets" {
  ...
  recaptcha_v3_site_key = var.recaptcha_v3_staging_site_key
  recaptcha_v3_secret = var.recaptcha_v3_staging_secret
  recaptcha_v2_site_key = var.recaptcha_v2_staging_site_key
