module "wbaas2-k8s-secrets" {
  ...
  sql_password_root = random_password.sql-passwords["root"].result
  sql_password_replication = random_password.sql-passwords["replication"].result
  sql_password_api = random_password.sql-passwords["api"].result
  sql_password_mediawiki_db_manager = random_password.sql-passwords["mediawiki-db-manager"].result
