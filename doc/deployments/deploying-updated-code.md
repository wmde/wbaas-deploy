...
> [!IMPORTANT]
> Skip this section if there is an automatically generated PR for the component after a commit has been pushed
...
## 3b. Deploying the code to staging
 ...
 - Checkout the pull request you want to deploy
 - Rebase the pull request you want to deploy onto main (e.g. `git rebase main`)
 ...
 - Push the commit(s) you just deployed with `git push`
 - Close the PR, merging it into `main`
